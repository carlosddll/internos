...
const interns = [
  ...
  "Jose Antonio Rojas",
  "Angelica Campos Romero", // Pendiente
];
const Interns2026 = () => {
  return (
    <section id="internos-2026" className="py-10 sm:py-16 md:py-24 bg-muted relative">
      <div className="container px-5 sm:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto font-body">
            Bienvenidos a nuestra nueva generación de internos que inician su etapa en Detecta Clínica
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-foreground font-display font-semibold text-lg">14 Internos</p>
            <p className="text-muted-foreground text-xs sm:text-sm">¡Bienvenidos a la familia Detecta!</p>
          </motion.div>
        </div>
      </div>
    </section>
