...
const interns = ["Alvaro Yamir Bazán Hernández", "Maria Lourdes Gutierrez Falconi", "Judith Rosario Arenas Vásquez", "Marlon Erick Ruiz Gonzalez Calderon", "Estrella Anaís Osorio Herrera", "Camila Xiomara Ñiquen Pareja", "Lucy Maribel Nicoll Centurion", "Genny Isabel Geldres Pinto", "Orlando Hernan Ernesto Correa Luna", "Lidia Miyoko Okimura Nunes", "Valeria Melanie Arias Quintanilla", "Gianella Ximena Rosas Villegas", "Jose Antonio Rojas", "" // Pendiente
];
const Interns2026 = () => {
  return <section id="internos-2026" className="py-10 sm:py-16 md:py-24 bg-muted relative">
