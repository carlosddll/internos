...
const interns = ["Ana Victoria Zegarra Ramos", "Angello Castillo Quincho", "Rodrigo Delgado Basurco", "Emanuel Alessandro Arias Ulfe", "Jhonny Alberto Orellana Gallegos", "Jose Jonathan Rondon Gonzales", "Katherine Lucía Perez Fuentes", "Mateo Joaquín Rodríguez Bambarén", "Milagros Nicole Peralta Gonzales", "Milca Paloma Portugal Limache", "Milton Sigur Knutzen Vargas", "Gabriel Aaron Yepez Cortez", "Christopher Giancarlo Rey Sánchez Bardales", "Lucero Castillo Poma"];
const Interns2025 = () => {
  return <section id="internos-2025" className="py-10 sm:py-16 md:py-24 bg-background relative">
      <div className="container px-5 sm:px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {interns.map((name, index) => <motion.div key={index} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
